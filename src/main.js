...
const languageData = {
  ...
  sv: {
    ...
    whoAmI: "Vem är jag?",
    iAm: "Jag är",
    descriptionMe: " Jag är en webbutvecklingsstudent med fokus på e-handel vid Grit Academy i Malmö. Jag brinner för att skapa moderna och användarvänliga webbplatser och applikationer med hjälp av HTML, CSS, JavaScript, WordPress. Hittills har jag utvecklat några projekt som visar mina kunskaper och min kreativitet. WordPress entusiast.",
    ShowMoreBtn: "Läs mer",
